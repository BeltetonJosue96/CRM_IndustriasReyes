                    ...
                    <form id="detalleVentaForm" action="{{ route('detalle_ventas.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 gap-4 mb-6">
                            ...
                            <div class="flex items-center">
                                ...
                                <input type="number" step="0.01" name="costo" id="costo" class="w-full p-3 border border-gray-300 rounded-lg dark:bg-gray-800 dark:border-gray-600 dark:text-white" required>
                            </div>
                            <div class="flex items-center">
