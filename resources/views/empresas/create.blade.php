            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="container mx-auto mt-8 bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md">
                        <h3 class="text-xl text-center font-semibold text-gray-800 dark:text-gray-200 mb-6">Registrar Nueva Empresa</h3>
                        @if ($errors->any())
                        ...
                        <form action="{{ route('empresas.store') }}" method="POST">
                            ...
                            <div class="grid grid-cols-1 gap-4 mb-6">
                                <div class="flex items-center">
                                    <label for="nombre" class="block text-lg font-medium text-gray-700 dark:text-gray-300 pr-4">Nombre de la empresa</label>
