        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h2 class="text-xl text-center font-semibold text-gray-800 dark:text-gray-200 mb-6">{{ __('Editar Estado') }}</h2>
                    @if ($errors->any())
                    ...
                    <form action="{{ route('estados.update', $estado->hashed_id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="id_producto" id="id_producto" value="{{ $estado->hashed_id }}"
