            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex flex-col items-center mt-2">
                        <form action="{{ route('modelos.index') }}" method="GET" class="flex items-center space-x-2">
                            <input type="text" name="search" value="{{ request('search') }}" placeholder="Buscar modelos..." class="px-4 py-2 border rounded-md dark:bg-gray-700 dark:text-white dark:border-gray-600">
                    ...
                    {{-- Paginación --}}
                    <div class="mt-6">
                        {{ $modelos->links('vendor.pagination.tailwind') }}
                    </div>
                </div>
            </div>
        </div>
