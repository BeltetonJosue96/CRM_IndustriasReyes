        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h2 class="text-xl text-center font-semibold text-gray-800 dark:text-gray-200 mb-6">Registrar Línea</h2>
                    @if ($errors->any())
                    ...
                    <form action="{{ route('lineas.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 gap-4 mb-6">
                            <div class="flex items-center">
                                ...
                                <input type="text" name="nombre" id="nombre" class="w-full p-3 border border-gray-300 rounded-lg dark:bg-gray-800 dark:border-gray-600 dark:text-white" required placeholder="Nombre de la Línea">
                            </div>
                            <script>
